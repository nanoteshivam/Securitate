...
public class Safety_Tutorials extends AppCompatActivity {
    ...
    private void initData(){
        ...
        versionsList.add(new Versions("#1 Self Defence for Women","Training","Watch Video","Focus on your attacker’s vulnerable places: eyes, nose, throat, and groin. Aim all of the moves below at one or several of these areas to have maximum impact.\nUse all of your force and aggression during execution. Make it known that you’re a powerful lady. Use your voice, too. Be loud to intimidate the attacker and create attention in case somebody is nearby." ));
        versionsList.add(new Versions("#2 Preventing sexual harassment","Training","Watch Video","According to various studies and reports, sexual harassment and assault are significant problems in the military, with a high number of incidents going unreported. These experiences can have a devastating impact on the lives and well-being of survivors, as well as erode trust and undermine unit cohesion.\n" +
                "\n" +
        ...
        versionsList.add(new Versions("#6 Online harassment and cyberstalking","Training","Watch Video","Focus on your attacker’s vulnerable places: eyes, nose, throat, and groin. Aim all of the moves below at one or several of these areas to have maximum impact.\nUse all of your force and aggression during execution. Make it known that you’re a powerful lady. Use your voice, too. Be loud to intimidate the attacker and create attention in case somebody is nearby." ));
        versionsList.add(new Versions("#7 Addressing gender-based violence","Training","Watch Video","Focus on your attacker’s vulnerable places: eyes, nose, throat, and groin. Aim all of the moves below at one or several of these areas to have maximum impact.\nUse all of your force and aggression during execution. Make it known that you’re a powerful lady. Use your voice, too. Be loud to intimidate the attacker and create attention in case somebody is nearby." ));
    }
}